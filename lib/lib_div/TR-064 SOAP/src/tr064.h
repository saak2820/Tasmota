...
class TR064 {
    public:
        ...
        bool action(const String& service, const String& act, String params[][2] = {}, int nParam = 0, String (*req)[2] = {}, int nReq = 0, const String& url = "");
        //bool action(const char* service, const char* act, char *params[][2] = {}, int nParam = 0, char *req[][2] = {}, int nReq = 0, const char* url = "");
